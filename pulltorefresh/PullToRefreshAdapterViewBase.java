...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	private boolean mShowIndicator=false;//默认不显示indicator
	...
	public void setOnChildClickListener(OnChildClickListener onChildClickListener){
	    if(mRefreshableView instanceof ExpandableListView){
	        ((ExpandableListView) mRefreshableView).setOnChildClickListener(onChildClickListener);
	    }
	}

	public void setGroupIndicator(Drawable groupIndicator){
	    if(mRefreshableView instanceof ExpandableListView){
            ((ExpandableListView) mRefreshableView).setGroupIndicator(groupIndicator);
        }
	}

	public void setOnGroupClickListener(OnGroupClickListener onGroupClickListener){
        if(mRefreshableView instanceof ExpandableListView){
            ((ExpandableListView) mRefreshableView).setOnGroupClickListener(onGroupClickListener);
        }
    }
