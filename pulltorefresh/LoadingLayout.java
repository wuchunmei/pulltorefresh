...
import cn.tianya.light.pulltorefresh.PullToRefreshBase.Mode;
import cn.tianya.light.pulltorefresh.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout implements
	...
	public void setNightModeChanged() {
	    setBackgroundColor(StyleUtils.getAppBackgroundColor(this.getContext()));

		setPullToRefreshTextColor(getResources().getColor(
				StyleUtils.getMainColorRes(this.getContext())));
		requestFocus();
	}
	...
	public void setNightMode(boolean isNight) {
		if (isNight) {
			...
			setPullToRefreshTextColor(getResources().getColor(R.color.font_maincolor_night));
		}else{
			setBackgroundColor(getResources().getColor(R.color.application_bg));
			setPullToRefreshTextColor(getResources().getColor(R.color.font_maincolor));
		}
		requestFocus();
	}
